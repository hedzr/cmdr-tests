...
require (
	github.com/hedzr/cmdr-loaders v1.2.7
...
require (
	...
	github.com/hedzr/store/codecs/hcl v1.2.3 // indirect
	github.com/hedzr/store/codecs/hjson v1.2.3 // indirect
	github.com/hedzr/store/codecs/json v1.2.3 // indirect
	github.com/hedzr/store/codecs/nestext v1.2.3 // indirect
	github.com/hedzr/store/codecs/toml v1.2.3 // indirect
	github.com/hedzr/store/codecs/yaml v1.2.3 // indirect
	github.com/hedzr/store/providers/env v1.2.3 // indirect
	github.com/hedzr/store/providers/file v1.2.3 // indirect
