...
require (
	github.com/hedzr/cmdr-loaders v1.2.10
	github.com/hedzr/cmdr/v2 v2.0.16
...
require (
	...
	github.com/hedzr/store/codecs/hcl v1.2.8 // indirect
	github.com/hedzr/store/codecs/hjson v1.2.8 // indirect
	github.com/hedzr/store/codecs/json v1.2.8 // indirect
	github.com/hedzr/store/codecs/nestext v1.2.8 // indirect
	github.com/hedzr/store/codecs/toml v1.2.8 // indirect
	github.com/hedzr/store/codecs/yaml v1.2.8 // indirect
	github.com/hedzr/store/providers/env v1.2.8 // indirect
	github.com/hedzr/store/providers/file v1.2.8 // indirect
